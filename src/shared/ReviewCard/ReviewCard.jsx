...
export default function ReviewCard({ name, review, image, rating = 5 }) {
  return (
    <div className="bg-[#f5f5f5] rounded-xl shadow-lg hover:shadow-xl p-6 py-8 text-center max-w-sm mx-auto transition-all duration-300 flex flex-col justify-between h-full transform hover:-translate-y-1 border border-gray-100">
      {/* Rating Stars */}
