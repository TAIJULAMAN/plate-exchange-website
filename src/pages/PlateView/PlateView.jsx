...
export default function PlateView() {
  ...
  const carImages = [
    { id: 1, type: "image", src: "/car (1).png" },
    { id: 2, type: "image", src: "/car (2).png" },
    { id: 3, type: "image", src: "/car (3).png" },
    { id: 4, type: "image", src: "/car (4).png" },
    { id: 5, type: "image", src: "/car (5).png" },
    { id: 6, type: "image", src: "/car (6).png" },
  ];
  ...
  return (
    <div className="container mx-auto px-5 md:px-0 py-10 md:py-16 font-manrope">
      {/* Header */}
        ...
        <div className="space-y-6">
          ...
          <div className="flex gap-3">
            <button
              ...
              className={`flex-1 px-4 py-2 rounded-full font-semibold text-2xl ${
                selectedView === "rear"
      ...
      <div className="mt-12">
        <div className="grid grid-cols-3 md:grid-cols-3 gap-4">
          {carImages.map((car) => (
            <div key={car.id} className="aspect-[3/3]">
              <img
