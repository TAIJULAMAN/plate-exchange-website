                ...
                <div className="space-y-6">
                    ...
                    <div className="border border-gray-300 rounded-lg p-6 space-y-6">
                        ...
                        <p className="text-gray-600 text-sm mb-6">
                            To Find Answers To Our Most Frequently Asked Questions Or Get In Contact
                            With Us, Please Tell Us How We Can Help. For Example, Type 'edit My Advert'
                        </p>
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="flex justify-center">
                                <button
                                    type="submit"
                                    className="bg-[#00823A] text-white px-8 py-2 rounded-full"
                                >
                                    Submit
                                </button>
                            </div>
