...
import { useGetRecentBlogsQuery, useGetSingleBlogQuery } from "../../Redux/api/blogApi";
...
export default function BlogDetails() {
  ...
  const { data: recentBlogs, isLoading: loadingRecentBlogs } = useGetRecentBlogsQuery();
  ...
  return (
    <div className="container mx-auto px-4 py-5 md:py-16">
      ...
      <div className="mb-8">
        ...
        <span className="text-gray-600">Published Blog</span>
      </div>
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            ...
            <div className="flex gap-4">
              {[
                ...
                { icon: Instagram, color: "bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600" },
