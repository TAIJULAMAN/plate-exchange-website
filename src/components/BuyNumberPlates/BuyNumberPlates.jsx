...
export default function BuyNumberPlates() {
        ...
        <div className="max-w-4xl mx-auto px-4 py-16">
            ...
            <div className="text-center mb-12">
                <h1 className="text-4xl md:text-5xl font-light text-gray-800 mb-2 leading-tight">
                    Buy Affordable Private Number Plates
                </h1>
                <h2 className="text-4xl md:text-5xl font-light text-gray-800 mb-8">
                    <span className="bg-yellow-400 px-2 py-1 rounded">Directly from Sellers</span>.
                </h2>
            </div>
            ...
            <div className="text-center mb-8">
                <p className="text-gray-600 leading-relaxed max-w-2xl mx-auto">
                    List your plate on PlateExchange—the transparent, seller-first marketplace. Connect
                    directly with buyers, skip the middlemen, and pay zero commission. More control,
                    <span className="text-blue-500 font-medium"> more cash in your pocket.</span>
                </p>
            </div>
